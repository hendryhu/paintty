...
const castleShape = {
  ...
  visible: true,
  cells: { '7,8': { c: '#' } },
} as unknown as EditorShapeLayer;
const helpers: Parameters<typeof textLayerAt>[4] = {
  isVisible: (layer) => layer.visible,
  offsetOf: (layer) => layer.offset ?? { x: 0, y: 0 },
...
const plainText = { text: 'ABCD', wrap: true } as EditorTextLayer;
...
const wrappedText = { text: 'AB CD\nEF', wrap: true } as EditorTextLayer;
...
const wideText = { text: 'A界B', wrap: true } as EditorTextLayer;
...
const emojiText = { text: 'A🙂B', wrap: true } as EditorTextLayer;
