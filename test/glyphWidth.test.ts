...
import { normalizeOutputGrid } from '../src/lib/outputGrid.ts';
import { activeChar, activeTool, paintColor } from '../src/lib/stores.ts';
import { applyTool } from '../src/lib/tools.ts';
import { dims, layers, setLayers } from '../src/lib/grid.ts';
...
const TERMINAL_WIDE: Array<[string, string]> = [
...
const TERMINAL_NARROW: Array<[string, string]> = [
