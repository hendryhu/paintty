...
export function resizeRightPanelFromPointer(startWidth: unknown, startClientX: unknown, clientX: unknown): number {
...
export function resizeRightPanelWithKey(width: unknown, key: string): number | null {
...
export function rightPanelDividerGeometry(viewportWidth: unknown, panelWidth: unknown) {
