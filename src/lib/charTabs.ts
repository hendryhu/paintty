...
] as const satisfies readonly CharacterTab[];

export function charsForTab(tab: CharacterTab, favourites: Iterable<string>): string[] {
...
export function codepoint(ch: unknown): string {
  return [...String(ch || '')]
